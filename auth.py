...
# JWT Configuration loaded from env or default fallback
SECRET_KEY = os.getenv("SECRET_KEY", "9a2f3e82d7b1a03f4e6c8b9d0a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b")
ALGORITHM = "HS256"
ACCESS_TOKEN_EXPIRE_MINUTES = 1440  # 24 hours token validity

# Bearer token extractor pointing to the login route
...
def get_current_user(token: str = Depends(oauth2_scheme), db: Session = Depends(get_db)) -> models.User:
    ...
    and returns the corresponding database User.
    """
